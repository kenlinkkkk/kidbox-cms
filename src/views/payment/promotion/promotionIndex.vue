  ...
  <div id="data-list-list-view" class="data-list-container">
    ...
    <vs-table ref="table" multiple v-model="selected" search :data="packages">
      ...
      <template slot="thead">
        ...
        <vs-th sort-key="start_time">Thời gian bắt đầu</vs-th>
        <vs-th sort-key="end_time">Thời gian kết thúc</vs-th>
        <vs-th sort-key="cycle">Chu kỳ</vs-th>
        <vs-th sort-key="discount">Chiết khấu</vs-th>
      ...
      <template slot-scope="{data}">
        ...
        <vs-tr :data="tr" :key="indextr" v-for="(tr, indextr) in data">
          ...
          <vs-td>
            <p class="product-start-time">{{ tr.start_time | formatDate }}</p>
          </vs-td>

          <vs-td>
            <p class="product-end-time">{{ tr.end_time | formatDate }}</p>
          </vs-td>

          <vs-td>
            <p class="product-cycle">{{ tr.cycle  }}</p>
          </vs-td>

          <vs-td>
            <p class="product-discount">{{ tr.discount  }}</p>
          </vs-td>
